...
const animals = [
    ...
    {name: "Keisaripingviini", image: "./images/pingviini.png", correctEnvironment: "antarktis", fact: "lisääntyessään keisaripingviininaaras munii yhden munan, jonka se vierittää koiraalle haudottavaksi. Sitten naaras lähtee merelle kalaisille vesille syömään ja viettää siellä talven. Koiras hautoo munaa jalkojensa päällä ihopoimun suojassa yhdeksän viikkoa.", options: [{ image: "./images/marine.png", environment: "meri" }, { image: "./images/välimeri.png", environment: "välimeri"}, { image: "./images/antarctic.jpg", environment: "antarktis" }]},
